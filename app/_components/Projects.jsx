  ...
  const projects = [
    {
      ...
      description:
        "A full-stack, AI-powered platform that helps users manage income, expenses, budgets, and receive smart financial insights.",
      longDescription:
            ...
            >
              <Card className="overflow-hidden hover:shadow-2xl transition-all duration-300 cursor-pointer dark:bg-gray-700 dark:border-gray-600">
                ...
                <CardFooter className="p-6 pt-0 flex gap-2">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => openModal(project)} className="ml-auto">
                    View Details
                  </Button>
                </CardFooter>
              </Card>
